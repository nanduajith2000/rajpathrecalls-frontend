              ...
              child:SingleChildScrollView(scrollDirection: Axis.vertical, child:Column(
                children:  [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children:  const [
                      Text('\nAbout',style: TextStyle(fontSize: 24.0,fontWeight: FontWeight.bold,color: Color(0xFFFA3232),fontFamily: 'OpenSans')),
                      Text('\nUs',style: TextStyle(fontSize: 24.0,color: Colors.white,fontFamily: 'OpenSans')),
                    ],
                  ),
